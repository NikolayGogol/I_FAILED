        ...
        .then(res => {
          ...
          if (res.lessonLearned) {
            createPostStore.lessonLearned = {
              whatILearned: res.lessonLearned.whatILearned || null,
              keyTakeaways: res.lessonLearned.keyTakeaways || null,
              whatIdDoDifferently: res.lessonLearned.whatIdDoDifferently || null,
              advice: res.lessonLearned.advice || null,
              recoveryTime: res.lessonLearned.recoveryTime || null,
              cost: res.lessonLearned.cost || 0,
            }
          }
        })
    }
